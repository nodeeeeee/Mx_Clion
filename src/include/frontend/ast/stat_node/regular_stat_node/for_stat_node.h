...
public:
    ForStatNode() = delete;
    ForStatNode(std::shared_ptr<VarDefNode> initial_var_def_node,std::shared_ptr<ExprNode> for_cond_expr_node, std::shared_ptr<StatNode> update_assign_stat_node, std::shared_ptr<BlockNode> block_node, Position position) : initial_var_def_nodes(std::move(initial_var_def_node)), for_cond_expr_node(std::move(for_cond_expr_node)), update_assign_stat_node(std::move(update_assign_stat_node)), block_node(std::move(block_node)), StatNode(position) {}
    ForStatNode(std::shared_ptr<StatNode> initial_assign_stat_node, std::shared_ptr<ExprNode> for_cond_expr_node, std::shared_ptr<StatNode> update_assign_stat_node, std::shared_ptr<BlockNode> block_node, Position position) : initial_assign_stat_node(std::move(initial_assign_stat_node)), for_cond_expr_node(std::move(for_cond_expr_node)), update_assign_stat_node(std::move(update_assign_stat_node)),block_node(std::move(block_node)), StatNode(position) {}
    ForStatNode(std::shared_ptr<ExprNode> initial_expr_node, std::shared_ptr<ExprNode> for_cond_expr_node, std::shared_ptr<StatNode> update_assign_stat_node, std::shared_ptr<BlockNode> block_node, Position position) : initial_expr_node(std::move(initial_expr_node)), for_cond_expr_node(std::move(for_cond_expr_node)), update_assign_stat_node(std::move(update_assign_stat_node)), block_node(std::move(block_node)), StatNode(position) {}
    ...
    ForStatNode(std::shared_ptr<StatNode> initial_assign_stat_node, std::shared_ptr<ExprNode> for_cond_expr_node, std::shared_ptr<ExprNode> update_expr_node, std::shared_ptr<BlockNode> block_node, Position position) : initial_assign_stat_node(std::move(initial_assign_stat_node)), for_cond_expr_node(std::move(for_cond_expr_node)), update_expr_node(std::move(update_expr_node)), block_node(std::move(block_node)), StatNode(position) {}
    ...
    const std::shared_ptr<StatNode> &getUpdateAssignStatNode() {return update_assign_stat_node;}
...
private:
    ...
    std::shared_ptr<StatNode> update_assign_stat_node;
    std::shared_ptr<ExprNode> update_expr_node;
    std::shared_ptr<StatNode> initial_assign_stat_node;
